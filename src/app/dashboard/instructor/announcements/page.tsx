...
export default function InstructorAnnouncementsPage() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        setLoading(true);
        const data = await listAnnouncementsForAudience(["ALL", "STUDENT", "INSTRUCTOR"]);
  ...
  return (
    <div className="space-y-6">
      <div className="card space-y-4">
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Publish Announcement</h2>
